...
class User(Base):
    ...
    date_format: Mapped[str] = mapped_column(String(16), server_default="iso")
    ...
    default_llm_response_language: Mapped[str] = mapped_column(String(16), server_default="en-US")
