...
async def test_discover_authorizes_before_returning_cached_result():
    ...
    user = User(id=uuid.uuid4(), email="discover-intruder@test.com", name="Intruder", hashed_password="x")
    ...
    portfolio_module._discover_cache[old_cache_key] = ([{"ticker": "LEAK", "reason": "private"}], time.time() + 60)
