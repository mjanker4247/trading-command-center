...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative inline-flex min-h-11 min-w-11 items-center justify-center touch-manipulation rounded-lg p-2 focus:outline-hidden focus:ring-2 focus:ring-blue-500/60"
    >
      <span className="relative block h-[22px] w-10 shrink-0 rounded-[11px] border border-input-border bg-input/70 transition-colors hover:border-blue-400">
        <span
